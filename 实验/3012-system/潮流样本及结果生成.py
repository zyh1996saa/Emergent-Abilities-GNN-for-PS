...
if __name__ == "__main__":
    ...
    for i in range(start,end):
        ...
        np.save(path+r'/数据/潮流(图)格式/3012-system/trainingSet/input/casezj_H_%s.npy'%i, Hi)
        save_npz(path+r'/数据/潮流(图)格式/3012-system/trainingSet/input/casezj_Y_%s'%i, Yi)
        ...
        sparse_Yi = csr_matrix(Yi)
        np.save(path+r'/数据/潮流(图)格式/3012-system/trainingSet/output/casezj_H_%s.npy'%i, Hi)
        save_npz(path+r'/数据/潮流(图)格式/3012-system/trainingSet/output/casezj_Y_%s'%i, Yi)
...
if __name__ == "__main__":
    ...
    for i in range(start,end):
        ...
        Hi,Yi,Si = case2AandH(new_case_i)
        sparse_Yi = csr_matrix(Yi)
        np.save(path+r'/数据/潮流(图)格式/3012-system/testSet/input/casezj_H_%s.npy'%i, Hi)
        save_npz(path+r'/数据/潮流(图)格式/3012-system/testSet/input/casezj_Y_%s'%i, Yi)
        ...
        Hi,Yi,Si = case2AandH(res_i)
        sparse_Yi = csr_matrix(Yi)
        np.save(path+r'/数据/潮流(图)格式/3012-system/testSet/output/casezj_H_%s.npy'%i, Hi)
        save_npz(path+r'/数据/潮流(图)格式/3012-system/testSet/output/casezj_Y_%s'%i, Yi)
